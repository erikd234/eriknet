  ...
  useEffect(() => {
    const handleKeyDown = (e) => {
      if (e.key === "ArrowLeft" || e.key === "ArrowUp") {
        ...
        e.preventDefault();
        handleNextClick();
      } else if (e.key === "Escape" && iFrameView) {
        e.preventDefault();
        handleIFrameClose();
      }
    };
    ...
    <>
      <div className="grid grid-cols-2 w-full h-full">
        ...
        <div className="relative">
          <button
            className={
              "map-nav-btn absolute top-1/2 -translate-y-1/2 z-50 right-3" +
          ...
          <button
            className={
              "map-nav-btn absolute top-1/2 -translate-y-1/2 z-50 left-3" + (selectedIndex == 0 ? " hidden" : "")
            }
